/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 438397068b34d5a6a822dbc0e8f6bd97)
// Runtime types generated with workerd@1.20260625.1 2025-10-08 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	CONTACT_TO_EMAIL: "david.horn.pawar@gmail.com" | "info@pfeils-catering.de";
	RESEND_API_KEY: string;
}
declare namespace Cloudflare {
	interface DevEnv {
		ASSETS: Fetcher;
		CONTACT_TO_EMAIL: "david.horn.pawar@gmail.com";
		RESEND_API_KEY: string;
	}
	interface ProdEnv {
		ASSETS: Fetcher;
		CONTACT_TO_EMAIL: "info@pfeils-catering.de";
		RESEND_API_KEY: string;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CONTACT_TO_EMAIL" | "RESEND_API_KEY">> {}
}
